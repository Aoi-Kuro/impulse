const Quiz_1_Problems = [
  ...
  { id:"P15", topic:"Vectors", answer:6.8926, units:["m"],
    text:"For the vectors $\\vec{A}$ and $\\vec{B}$, find the magnitude of the vector sum $\\vec{A} + \\vec{B}$. Vector $\\vec{A}$ is 7 m and vector $\\vec{B}$ is 12 m long. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed.webp\" alt=\"figure\"></div>" },

  { id:"P16", topic:"Vectors", answer:17.418, units:["m"],
    text:"For the vectors $\\vec{A}$ and $\\vec{B}$, find the magnitude of the vector difference $\\vec{A} - \\vec{B}$. Vector $\\vec{A}$ is 7 m and vector $\\vec{B}$ is 11 m long. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed.webp\" alt=\"figure\"></div>" },

  { id:"P17", topic:"Vectors", answer:3.5, units:["m"],
    text:"Vector $\\vec{B}$ is 7 m long, see image below. Find the $x$-component of the vector $\\vec{B} = x\\mathbf{\\hat{i}} + y\\mathbf{\\hat{j}}$. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed.webp\" alt=\"figure\"></div>" },
  ...
  { id:"P22", topic:"Vectors", answer:81.8471, units:[],
    text:"Find the magnitude of the vector product $\\vec{A} \\times \\vec{B}$ of the two vectors in the figure below. The magnitudes of the vectors are $|\\vec{A}|$ = 8 and $|\\vec{B}|$ = 10.5. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(1).webp\" alt=\"figure\" width=\"300px\"></div>" },
  ...
  { id:"P99", topic:"Friction", answer:749.53631, units:["N"],
    text:"Figure shows two blocks with masses $m_{1}$ = 20.6 kg and $m_{2}$ = 61.2 kg; the blocks are free to move. The surface beneath $m_{2}$ is frictionless and the coefficient of static friction between the blocks is 0.36. Find the minimal force $F$ required to hold $m_{1}$ against $m_{2}$? <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(11).webp\" alt=\"figure\"></div>" },

  { id:"P100", topic:"Friction", answer:9.56522, units:["m/s^2"],
    text:"Figure shows two blocks with masses $m_1$ = 21 kg and $m_2$ = 59.5 kg. A horizontal force $F$ = 770 N presses $m_1$ against the vertical face of $m_2$, and the coefficient of static friction between the blocks is large enough that $m_1$ does not slip down. The surface beneath $m_2$ is frictionless. Find the magnitude of the acceleration of the two blocks. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(11).webp\" alt=\"figure\"></div>" },
  ...
  { id:"P102", topic:"Newton’s 2nd law", answer:42.2897, units:["N"],
    text:"A cord exerts a force $F$ = 12 N at an angle $\\theta$ = 34° above the horizontal to a block of mass 5 kg, pulling the block along a horizontal frictionless floor. What is the magnitude of the normal force exerted on the mass by the floor? <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(12).webp\" alt=\"figure\"></div>" },
  ...
  { id:"P121", topic:"Application of Newton’s laws", answer:5399.518, units:["N"],
    text:"Two ropes are connected to a steel cable that supports a hanging weight. If the maximum tension either rope can sustain without breaking is 4200 N, determine the maximum value of the hanging weight that those ropes can safely support. Ignore the weight of the ropes and the steel cable. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(14).webp\" alt=\"figure\"></div>" },

  { id:"P122", topic:"Application of Newton’s laws", answer:1954.7, units:["N"],
    text:"Two ropes are connected to a steel cable that supports a hanging weight of 3850 N. The ropes make angles of 60° and 40° with the ceiling, as shown in the figure. Determine the tension in the rope that makes the 40° angle with the ceiling. Ignore the weight of the ropes and the steel cable. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(14).webp\" alt=\"figure\"></div>" },

  { id:"P123", topic:"Application of Newton’s laws", answer:220.0, units:["N"],
    text:"A worker lifts a weight of 440 N by pulling down on a rope with a force $F$. Find the magnitude of the force $F$ if the weight is lifted at a constant speed. Assume that the rope, pulleys, and chains all have negligible weights. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(15).webp\" alt=\"figure\"></div>" },

  { id:"P124", topic:"Application of Newton’s laws", answer:230.714, units:["N"],
    text:"A worker lifts a weight of 380 N using the arrangement of pulleys shown in the figure, by pulling down on a rope with a force $F$. Find the magnitude of the force $F$ if the weight is lifted with a constant upward acceleration of 2.1 m s$^{-2}$. Assume that the rope, pulleys, and chains all have negligible weight. The gravitational acceleration is $g$ = 9.8 m s$^{-2}$. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(15).webp\" alt=\"figure\"></div>" },

  { id:"P125", topic:"Application of Newton’s laws", answer:10.666, units:["N"],
    text:"The clothesline has a mass 600 g, and each end makes an angle 16° with horizontal. What is the tension at each end of the clothesline? The gravitational acceleration is $g$ = 9.8 m s$^{-2}$. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(16).webp\" alt=\"figure\"></div>" },
  ...
  { id:"P127", topic:"Application of Newton’s laws", answer:195.7938, units:["kg"],
    text:"A block with mass $m_{1}$ = 280 kg is placed on an inclined plane with slope angle $\\alpha$ = 39° and is connected to a second hanging block with mass $m_{2}$ by a cord passing over a small, frictionless pulley. The coefficient of kinetic friction is 0.09. Find the mass $m_{2}$ for which block $m_{1}$ moves up the plane at constant speed once it is set in motion. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(17).webp\" alt=\"figure\"></div>" },

  { id:"P128", topic:"Application of Newton’s laws", answer:62.75, units:["kg"],
    text:"A block with mass $m_{1}$ = 150 kg is placed on an inclined plane with slope angle $\\alpha$ = 29° and is connected to a second hanging block with mass $m_{2}$ by a cord passing over a small, frictionless pulley. The coefficient of kinetic friction is 0.076. Find the mass $m_{2}$ for which block $m_{1}$ moves down the plane at constant speed once it is set in motion. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(17).webp\" alt=\"figure\"></div>" },
  ...
  { id:"P130", topic:"Application of Newton’s laws", answer:1590.14, units:["N"],
    text:"A block with mass $m_1$ = 225 kg is placed on an inclined plane with slope angle $\\alpha$ = 42° and is connected to a second hanging block by a cord passing over a small, frictionless pulley. The coefficient of kinetic friction between $m_1$ and the incline is 0.07. Find the tension in the cord for which $m_1$ moves up the plane at constant speed once it is set in motion. The gravitational acceleration is $g$ = 9.8 m s$^{-2}$. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(17).webp\" alt=\"figure\"></div>" },

  { id:"P131", topic:"Application of Newton’s laws", answer:10.1567, units:["N"],
    text:"Block $A$ weighs 72 N. The coefficient of static friction between the block and the surface on which it rests is 0.29. Angle of the cord with horizontal is $\\alpha$ = 52°. The weight $w$ is 13 N and the system is in equilibrium. Find the friction force exerted on block $A$. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(18).webp\" alt=\"figure\"></div>" },

  { id:"P132", topic:"Application of Newton’s laws", answer:17.76, units:["N"],
    text:"Block $A$ weighs 74 N. The coefficient of static friction between the block and the surface on which it rests is 0.24. Angle of the cord with horizontal is $\\alpha$ = 45°. Find the maximum weight $w$ for which the system will remain in equilibrium. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(18).webp\" alt=\"figure\"></div>" },

  { id:"P133", topic:"Application of Newton’s laws", answer:0.176374, units:[],
    text:"Block $A$ weighs 62 N and rests on a horizontal surface. The angle of the cord with the horizontal is $\\alpha$ = 58°. The weight $w$ is 17.5 N and the system is in equilibrium. What is the minimum coefficient of static friction between block $A$ and the surface on which it rests? <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(18).webp\" alt=\"figure\"></div>" },

  { id:"P134", topic:"Application of Newton’s laws", answer:0.748, units:["N"],
    text:"Block $A$ weighs 1.3 N and $B$ weighs 3.1 N. The coefficient of kinetic friction between block $B$ and the surfaces is 0.17, and coefficient of static friction between block $A$ and block $B$ is 0.17. Find the magnitude of the horizontal force $F$ necessary to drag block $B$ to the left at constant speed if $A$ rests on $B$ and moves with it. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(19).webp\" alt=\"figure\"></div>" },

  { id:"P135", topic:"Application of Newton’s laws", answer:1.32, units:["N"],
    text:"Block $A$ weighs 1.1 N and $B$ weighs 3.3 N. The coefficient of kinetic friction between all surfaces is 0.24. Find the magnitude of the horizontal force $F$ necessary to drag block $B$ to the left at constant speed if $A$ is held at rest. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(20).webp\" alt=\"figure\"></div>" },

  { id:"P136", topic:"Application of Newton’s laws", answer:0.731, units:["N"],
    text:"Block $A$ weighs 1.15 N and block $B$ weighs 3.15 N. The coefficient of kinetic friction between block $B$ and the floor is 0.17. The cord shown in the figure connecting block $A$ to the wall has been cut, so block $A$ rests freely on top of $B$ and moves together with it. Find the magnitude of the horizontal force $F$ necessary to drag block $B$ to the left at constant speed. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(19).webp\" alt=\"figure\"></div>" },

  { id:"P137", topic:"Application of Newton’s laws", answer:18.245804831566, units:["N"],
    text:"A window washer pushes his scrub brush up a vertical window at constant speed by applying a force $F$ at an angle $\\alpha$ = 58.8°. The brush weighs 14 N and the coefficient of kinetic friction is $\\mu_{\\text{k}}$ = 0.17. Calculate the magnitude of the force $F$. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(21).webp\" alt=\"figure\"></div>" },

  { id:"P138", topic:"Application of Newton’s laws", answer:7.0445, units:["N"],
    text:"A window washer pushes his scrub brush up a vertical window at constant speed by applying a force $F$ at an angle $\\alpha$ = 54.8°. The brush weighs 9 N and the coefficient of kinetic friction is $\\mu_{\\text{k}}$ = 0.14. Calculate the normal force exerted by the window on the brush. <div class=\"fig-img-wrap\"><img src=\"course/images/quiz_1/unnamed(21).webp\" alt=\"figure\"></div>" },
